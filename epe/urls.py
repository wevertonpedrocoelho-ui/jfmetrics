...
urlpatterns = [
    ...
    path("configuracao/", views.settings, name="settings"),  # use só esta (evita duplicar "settings/")

    # Projetos
    path("projetos/", views.project_list, name="project_list"),

    # Catálogos (próprios do EPE): Atividade Geral e Tamanho de Painel (opcionais, se tiver view)
    path("catalogos/", views.catalogs, name="catalogs"),  # página índice dos catálogos
    path("catalogos/atividades-gerais/", views.general_list, name="general_list"),
    path("catalogos/tamanhos/", views.size_list, name="size_list"),
