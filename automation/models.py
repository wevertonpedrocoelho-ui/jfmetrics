...
from django.db.models import Q  # pode remover se não for usar
...
class Workday(models.Model):
    # Aponta para o modelo central de colaboradores
    collaborator = models.ForeignKey(
        "common.Collaborator",
        verbose_name="Colaborador",
        on_delete=models.PROTECT,
        related_name="automation_workdays",
        related_query_name="automation_workday",
    )
...
class Activity(models.Model):
    # Também aponta para o modelo central de colaboradores
    collaborator = models.ForeignKey(
        "common.Collaborator",
        verbose_name="Colaborador",
        on_delete=models.PROTECT,
        related_name="automation_activities",
        related_query_name="automation_activity",
    )
    ...
    # Alternativa ad-hoc (quando não se encaixa na EAP)
    ...
    # --- validações de coerência da EAP/ad-hoc ---
    def clean(self):
        super().clean()
