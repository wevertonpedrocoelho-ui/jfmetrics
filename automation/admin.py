...
# Opcional: títulos do admin (coloque em um único app do projeto)
admin.site.site_header = "jfmetrics — Administração"
admin.site.site_title  = "jfmetrics Admin"
...
class WorkdayAdmin(admin.ModelAdmin):
    ...
    autocomplete_fields = ("collaborator",)  # Collaborator vem do app common
    date_hierarchy = "date"
